...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const orderedFileNames = [
            ...
            "propietario.json", // No dependencies
            "alojamiento.json", // Depends on location and manager
            "inquilino.json", // No dependencies
            "lease.json", // Depends on property and tenant
            "solicitud.json", // Depends on property and tenant
