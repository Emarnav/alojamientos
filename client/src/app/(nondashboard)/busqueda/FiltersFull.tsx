  ...
  return (
    <div className="bg-white rounded-lg px-4 h-full overflow-auto pb-10">
      <div className="flex flex-col space-y-6">
        ...
        {/* m² */}
        <div>
          <h4 className="font-bold mb-2">Superficie</h4>
          <Slider
            min={0}
            max={5000}
            step={100}
            value={[
              localFilters.superficie[0] ?? 0,
              localFilters.superficie[1] ?? 5000,
            ]}
            onValueChange={(value) =>
              setLocalFilters((prev) => ({
                ...prev,
          ...
          />
          <div className="flex justify-between mt-2">
            <span>{localFilters.superficie[0] ?? 0} m²</span>
            <span>{localFilters.superficie[1] ?? 5000} m²</span>
          </div>
        </div>
        ...
        <div>
          ...
          <Input
            type="date"
            value={
              localFilters.disponibleDesde !== "any"
                ? localFilters.disponibleDesde
                : ""
            }
            onChange={(e) =>
              setLocalFilters((prev) => ({
